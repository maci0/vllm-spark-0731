...
Items 3-5 ship as one verified diff, `patches/v0.27.1/combined-v0.27.1.patch`
(29 files, 3038 lines, applies to pristine v0.27.1 with exit 0). The individual
inputs are kept under `patches/upstream/` for review (`*-vllm-only.diff`,
`kv-offload-bounds-check.patch`).
