...
출처: [DeepSeek 모델 카드](https://huggingface.co/deepseek-ai/DeepSeek-V4-Flash-0731), [단일 Spark 레시피](https://github.com/MiaAI-Lab/DeepSeek-v4-Flash-One-DGX-Spark), [성능 리서치](https://github.com/recrack/oh-my-dgx-spark/blob/main/docs/deepseek-v4-flash-0731-performance-research-2026-08.md).
...
출처: [Qwen3.8 community builds](https://github.com/recrack/oh-my-dgx-spark/blob/main/docs/qwen38-community-builds-2026-08.md), [MiaAI-Lab 레시피](https://github.com/MiaAI-Lab/Qwen3.8-27B-SGLang-DGX-Spark).
