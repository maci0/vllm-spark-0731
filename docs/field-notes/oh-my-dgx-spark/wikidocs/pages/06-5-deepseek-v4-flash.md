...
이 페이지의 결론은 06-4 모델 선택의 선택 허브를 보완한다. 설치 순서는 03-4 첫 모델 증명, 비교 조건은 10-4 Sol과 로컬 모델 비교를 따른다.
...
- [DeepSeek 커뮤니티 제작물](https://github.com/recrack/oh-my-dgx-spark/blob/main/docs/deepseek-v4-flash-0731-community-builds-2026-08.md)
