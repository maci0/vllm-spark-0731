...
> 이 장은 커뮤니티가 만든 결과물과 재현 후보를 모아 두는 사례 장이다. 현재 장비에서 무엇부터 실행할지는 06-4 모델 선택과 06-5 DeepSeek 실행 프로필에서 결정한다. 아래 수치는 출처의 주장 또는 커뮤니티 실측이며, 이 저장소의 직접 실측은 별도로 표시한다.
...
- [DeepSeek 커뮤니티 제작물·응용 사례 원문 리서치](https://github.com/recrack/oh-my-dgx-spark/blob/main/docs/deepseek-v4-flash-0731-community-builds-2026-08.md)
- 로컬 에이전트 운영
- 두 대 연결하기
- 부록: 모델·레시피·명령어 색인
