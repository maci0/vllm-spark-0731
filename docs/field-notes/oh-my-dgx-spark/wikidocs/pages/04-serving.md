...
- 04-1. vLLM·SGLang·llama.cpp·SparkInfer 선택: 엔진별 성격과 기능·속도 기준선을 다룹니다.
- 04-2. 엔진 선택 체크리스트: 목적부터 고르는 짧은 결정 순서입니다.
- 04-3. OpenAI-compatible endpoint와 tool parser: 서버 기동과 tool call 검증을 분리합니다.
