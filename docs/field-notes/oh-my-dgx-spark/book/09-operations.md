...
참고: [커뮤니티 사례 원문](https://x.com/Blackwellboy/status/2090611479653622261?s=20), [DGX Spark 포럼 리서치](../docs/dgx-spark-nvidia-forum-research-2026-08.md).
...
- [09-1. 발열·OOM·NCCL·펌웨어 장애](09-1-operations-failure-recovery.md): 장애를 네 계층으로 나누고 전체 복구 순서를 설명합니다.
- [09-2. 장애 발생 후 첫 5분](09-2-first-five-minutes.md): 재부팅 전에 수집할 정보를 정리합니다.
- [09-3. 저클럭·OOM·NCCL 대응](09-3-clock-oom-nccl.md): 증상별 최소 대응 순서입니다.
