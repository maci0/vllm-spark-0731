...
모델별 본문은 주로 [06장. 모델 레시피](06-model-recipes.md), 클러스터 자료는 [07장. 여러 Spark와 네트워크](07-cluster.md), 운영 장애는 [09장. 발열·장애·복구](09-operations.md)로 승격합니다. 리서치 원문은 날짜별 서브챕터에 남겨 출처의 변화와 과거 판단을 추적할 수 있게 합니다.
...
자동화 구현과 보고서 형식은 [리서치 자동화 문서](../docs/research-automation.md), 승격 규칙은 [리서치 승격 규칙](../docs/research-promotion.md), 참고문헌 목록은 [책 참고문헌](../docs/dgx-spark-book-references-2026-08.md)을 봅니다.

## 초기 기록과 날짜별 원문

[B-0. 자동 리서치 초기 기록](appendix-b-0-research-log-initial.md)은 기존 원고에 있던 첫 수집 흐름과 daily 기록 형식을 보존합니다. 이후 자동 수집 보고서는 이 장의 하위 페이지로 날짜순으로 생성됩니다.
