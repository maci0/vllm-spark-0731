...
MiniMax-H3를 DeepSeek·Qwen·MiniMax M2.7/M3의 언어 모델 비교표에 넣지 않는다. 모델 선택의 전체 구조는 [06-4](06-4-model-selection.md), 커널·장애 점검은 [09-1](09-1-operations-failure-recovery.md)과 연결한다.
...
MiniMax M2.7·M3는 텍스트 에이전트와 tool calling을 검토하는 [06-7](06-7-minimax-m2-m3.md)에 남긴다. H3는 다음 용도로 분리한다.
...
- [MiniMax M2.7과 M3](06-7-minimax-m2-m3.md)
