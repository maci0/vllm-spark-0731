...
이 결과는 GPT-5.6 Sol과 같은 task set을 실행한 결과가 아니며, DeepSeek 공식 Harness 전체를 재현한 결과도 아닙니다. raw 결과는 [`docs/results-deepseek-c1-2026-08-22.json`](../docs/results-deepseek-c1-2026-08-22.json)과 tool-loop JSON에 보존되어 있습니다.
...
참고: [NVIDIA Performance Benchmarking Guide](https://github.com/NVIDIA/dgx-spark-playbooks/blob/main/nvidia/connect-two-sparks/assets/performance_benchmarking_guide.md), [Sol 비교 리서치](../docs/sol-max-comparison-research-2026-08.md).

## 더 자세히 읽기

- [05-1. 벤치마크 설계 상세](05-1-benchmark-design.md): Level 0부터 soak까지의 전체 하니스와 결과 예시를 다룹니다.
- [05-2. 벤치마크 레벨](05-2-benchmark-levels.md): 최소 실행 순서를 빠르게 확인합니다.
- [05-3. 결과 기록과 비교표](05-3-report-schema.md): 비교에 필요한 필드와 판정 규칙을 제공합니다.
