...
DeepSeek V4 Flash 0731을 실제 에이전트에 연결한 커뮤니티 제작물과 통합 실패 사례는 [06-9: DeepSeek V4 Flash 0731로 사람들이 만든 것](06-9-deepseek-community-builds.md)에 별도로 정리했다. Qwen3.8-27B의 serving recipe와 코딩 에이전트 활용 사례는 [06-12: Qwen3.8-27B로 사람들이 만든 것](06-12-qwen38-community-builds.md)에 정리했다. 이 장에서는 운영 구조와 권한 경계를 다룬다.
