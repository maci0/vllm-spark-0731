...
따라서 같은 task set, 같은 harness, 같은 성공 판정으로 비용과 wall time까지 함께 측정하기 전에는 모델의 전반적인 지능이나 Sol max 대체 가능성을 주장할 수 없습니다. 자세한 근거는 [Sol max 비교 리서치](../docs/sol-max-comparison-research-2026-08.md)와 [DeepSeek 성능 리서치](../docs/deepseek-v4-flash-0731-performance-research-2026-08.md)에 정리했습니다.
