...
- [08-1. 로컬 에이전트 운영 상세](08-1-local-agent-operations.md): Hermes·OpenClaw·NemoClaw, 권한, thinking과 fallback을 다룹니다.
- [08-2. endpoint 계약](08-2-endpoint-contract.md): 에이전트가 기대하는 API 계약을 점검합니다.
- [08-3. brain·worker·권한 분리](08-3-agent-roles-permissions.md): DeepSeek와 Qwen을 역할별로 배치하는 기준입니다.
