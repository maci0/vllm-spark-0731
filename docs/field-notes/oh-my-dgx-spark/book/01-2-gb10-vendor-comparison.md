...
AMD Ryzen AI Halo와 Apple Mac Studio는 메모리 용량만 보면 경쟁 대안이지만, CUDA·DGX OS·ConnectX-7·NCCL recipe가 같은 장비가 아니다. [01-5. 구매·클러스터·재현](01-5-buying-cluster-reproduction.md)에서 이 경계를 따로 다룬다.
...
자세한 출처와 표는 [DGX Spark·GB10 벤더 비교 리서치](../docs/dgx-spark-vendor-comparison-2026-08.md)에 기록한다.
