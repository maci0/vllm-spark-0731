...
M2.7·M3의 세부 사례는 이 페이지에 남기고, Qwen·DeepSeek와 무엇을 비교할지는 [06-4 모델 선택](06-4-model-selection.md)의 목적별 표를 따른다.
...
- [MiniMax 모델 리서치](../docs/dgx-spark-model-selection-research-2026-08.md)
