...
| 질문 | 확인할 관점 | 다음 장 |
|---|---|---|
| 모델을 크게 올리는 것이 목적입니까? | capacity와 실제 decode 속도를 분리 | [02장](02-gb10-architecture.md) |
| 빠른 단일 사용자 응답이 목적입니까? | memory bandwidth·quant·speculative decoding | [03-4](03-4-single-spark-first-model.md) → [05-1](05-1-benchmark-design.md) |
| 여러 사람이 동시에 사용할 예정입니까? | aggregate throughput·동시성·노드 수 | [07-1](07-1-two-spark-cluster.md) → [07-4](07-4-multi-spark-scaling.md) |
| CUDA 모델 개발과 fine-tuning이 목적입니까? | aarch64·CUDA·컨테이너·작업 시간 | [03-1](03-1-first-boot-safe-environment.md) → [10-1](10-1-cost-power-decision.md) |
| 개인 데이터와 endpoint를 로컬에 두려는 것입니까? | 운영·보안·백업·복구 책임 | [08-1](08-1-local-agent-operations.md) → [09-1](09-1-operations-failure-recovery.md) |
