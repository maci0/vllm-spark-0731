...
## 2026-09-22: pooled ours-vs-ref across three clean pairs — +2.0/+1.9 (round 122)
...
| **ours mean** | **63.1** | **112.0** | **146.6** | **162.3** | **483.8** |
...
**Pooled: +1.97 % sum / +1.88 % c6.** All gates pass in all 8 arms
...
`moe=humming`, verified; every ref arm a `sparkrun_*` container. Every ours
arm beats every ref arm on the sum (min ours 480.3 > max ref 477.1).

Per-level pooled deltas (ours-ref): c1 +2.0 %, c3 -1.1 %, c5 +4.5 %, c6
+1.9 %. The c3 deficit is the only level where the reference leads; c5 is
the largest lead and the only level where the lead approaches spread size.
Round-116's q-pair-only figures (+2.8/+2.5) stand as written in their own
note; this pool is a separate 8-arm reading and does not revise it.
...
## 2026-09-22: ledger steady a third time at 211 guarded (round 168)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present, working tree clean. Fourth quiet round
with no upstream movement and no new measurement. Standing remains
`ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.

## 2026-09-22: ledger steady at 211 guarded, tree clean — nothing to push (round 164)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 10 key medians present locally, working tree clean. With no
new measurement and no upstream movement, there is correctly nothing to
commit this round — the record stands as pushed at round 163. Standing
...
## 2026-09-22: protocol re-verified a sixth time — routine unbroken (round 170)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a sixth time against current
files. Same prompt both engines, all 160 blocks full 512 tokens (zero
truncations), health 200 first poll on all 5 passes per arm, `vllm-ds4-0731`
on all four ours arms, `sparkrun_*` on all four ref arms. Six consecutive
...
## 2026-09-22: ledger steady sixth time at 211, tree clean (round 175)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Seventh
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady seventh time at 211, tree clean (round 176)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Eighth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady eighth time at 211, tree clean (round 177)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean. Ninth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady ninth time at 211, tree clean (round 178)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean. Tenth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady tenth time at 211, tree clean (round 179)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Eleventh
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady eleventh time at 211, tree clean (round 180)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Twelfth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady twelfth time at 211, tree clean (round 181)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Thirteenth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady thirteenth time at 211, tree clean (round 182)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Fourteenth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady fourteenth time at 211, tree clean (round 183)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Fifteenth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified an eighth time — routine unbroken (round 184)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read an eighth time against current
files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Eight consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady fifteenth time at 211, tree clean (round 185)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean.
Seventeenth quiet round with no upstream movement and no new measurement.
Standing remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a ninth time — routine unbroken (round 186)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a ninth time against current
files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Nine consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady sixteenth time at 211, tree clean (round 187)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Eighteenth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady seventeenth time at 211, tree clean (round 188)
...
Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean.
Nineteenth quiet round with no upstream movement and no new measurement.
Standing remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a tenth time — routine unbroken (round 189)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a tenth time against current
files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Ten consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady eighteenth time at 211, tree clean (round 190)
...
Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean.
Twenty-first quiet round with no upstream movement and no new measurement.
Standing remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified an eleventh time — routine unbroken (round 191)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read an eleventh time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Eleven consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady nineteenth time at 211, tree clean (round 192)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Twenty-third
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a twelfth time — routine unbroken (round 193)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a twelfth time against current
files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Twelve consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady twentieth time at 211, tree clean (round 194)
...
Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean.
Twenty-fifth quiet round with no upstream movement and no new measurement.
Standing remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a thirteenth time — routine unbroken (round 195)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a thirteenth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Thirteen consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady twenty-first time at 211, tree clean (round 196)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Twenty-sixth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a fourteenth time — routine unbroken (round 197)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a fourteenth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Fourteen consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady twenty-second time at 211, tree clean (round 198)
...
Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean.
Twenty-eighth quiet round with no upstream movement and no new measurement.
Standing remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a fifteenth time — routine unbroken (round 199)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a fifteenth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Fifteen consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady twenty-third time at 211, tree clean (round 200)
...
Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean.
Thirtieth quiet round with no upstream movement and no new measurement.
Standing remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a sixteenth time — routine unbroken (round 201)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a sixteenth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Sixteen consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady twenty-fourth time at 211, tree clean (round 202)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Thirty-first
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a seventeenth time — routine unbroken (round 203)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a seventeenth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Seventeen consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady twenty-fifth time at 211, tree clean (round 204)
...
Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean.
Thirty-third quiet round with no upstream movement and no new measurement.
Standing remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified an eighteenth time — routine unbroken (round 205)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read an eighteenth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Eighteen consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady twenty-sixth time at 211, tree clean (round 206)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Thirty-fifth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a nineteenth time — routine unbroken (round 207)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a nineteenth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Nineteen consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady twenty-seventh time at 211, tree clean (round 208)
...
Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean.
Thirty-seventh quiet round with no upstream movement and no new measurement.
Standing remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a twentieth time — routine unbroken (round 209)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a twentieth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Twenty consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady twenty-eighth time at 211, tree clean (round 210)
...
Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean.
Thirty-ninth quiet round with no upstream movement and no new measurement.
Standing remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a twenty-first time — routine unbroken (round 211)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a twenty-first time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Twenty-one consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady twenty-ninth time at 211, tree clean (round 212)
...
Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean.
Forty-first quiet round with no upstream movement and no new measurement.
Standing remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a twenty-second time — routine unbroken (round 213)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a twenty-second time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Twenty-two consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady thirtieth time at 211, tree clean (round 214)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Forty-third
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a twenty-third time — routine unbroken (round 215)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a twenty-third time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Twenty-three consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady thirty-first time at 211, tree clean (round 216)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Forty-fifth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a twenty-fourth time — routine unbroken (round 217)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a twenty-fourth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Twenty-four consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady thirty-second time at 211, tree clean (round 218)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Forty-seventh
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a twenty-fifth time — routine unbroken (round 219)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a twenty-fifth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
...
## 2026-09-22: protocol re-verified a twenty-sixth time — routine unbroken (round 221)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a twenty-sixth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Twenty-six consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady thirty-fourth time at 211, tree clean (round 222)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Fifty-first
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a twenty-seventh time — routine unbroken (round 223)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a twenty-seventh time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Twenty-seven consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady thirty-fifth time at 211, tree clean (round 224)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Fifty-third
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a twenty-eighth time — routine unbroken (round 225)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a twenty-eighth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Twenty-eight consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady thirty-sixth time at 211, tree clean (round 226)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Fifty-fourth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a twenty-ninth time — routine unbroken (round 227)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a twenty-ninth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Twenty-nine consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady thirty-seventh time at 211, tree clean (round 228)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Fifty-sixth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a thirtieth time — routine unbroken (round 229)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a thirtieth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Thirty consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady thirty-eighth time at 211, tree clean (round 230)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Fifty-eighth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a thirty-first time — routine unbroken (round 231)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a thirty-first time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Thirty-one consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady thirty-ninth time at 211, tree clean (round 232)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean. Sixtieth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a thirty-second time — routine unbroken (round 233)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a thirty-second time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Thirty-two consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady fortieth time at 211, tree clean (round 234)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean. Sixty-second
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a thirty-third time — routine unbroken (round 235)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a thirty-third time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Thirty-three consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady forty-first time at 211, tree clean (round 236)
...
Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean.
Sixty-fourth quiet round with no upstream movement and no new measurement.
Standing remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a thirty-fourth time — routine unbroken (round 237)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a thirty-fourth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Thirty-four consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady forty-second time at 211, tree clean (round 238)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Sixty-fifth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a thirty-fifth time — routine unbroken (round 239)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a thirty-fifth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Thirty-five consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady forty-third time at 211, tree clean (round 240)
...
Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean.
Sixty-seventh quiet round with no upstream movement and no new measurement.
Standing remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a thirty-sixth time — routine unbroken (round 241)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a thirty-sixth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Thirty-six consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady forty-fourth time at 211, tree clean (round 242)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Sixty-eighth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a thirty-seventh time — routine unbroken (round 243)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a thirty-seventh time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Thirty-seven consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady forty-fifth time at 211, tree clean (round 244)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean. Seventieth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a thirty-eighth time — routine unbroken (round 245)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a thirty-eighth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Thirty-eight consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady forty-sixth time at 211, tree clean (round 246)
...
Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean.
Seventy-second quiet round with no upstream movement and no new measurement.
Standing remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a thirty-ninth time — routine unbroken (round 247)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a thirty-ninth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Thirty-nine consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady forty-seventh time at 211, tree clean (round 248)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Seventy-third
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a fortieth time — routine unbroken (round 249)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a fortieth time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Forty consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady forty-eighth time at 211, tree clean (round 250)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all key medians present locally, working tree clean. Seventy-fifth
quiet round with no upstream movement and no new measurement. Standing
remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a forty-first time — routine unbroken (round 251)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a forty-first time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Forty-one consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady forty-ninth time at 211, tree clean (round 252)
...
Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean.
Seventy-sixth quiet round with no upstream movement and no new measurement.
Standing remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a forty-second time — routine unbroken (round 253)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a forty-second time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
containers per arm). Forty-two consecutive rounds certify identical inputs
without exception. The beat is engine-only; nothing moves the keep verdict.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: ledger steady fiftieth time at 211, tree clean (round 254)
...
Housekeeping only: ledger regenerates to 211 guarded / 0 superseded with
zero diff, all 12 key medians present locally, working tree clean.
Seventy-ninth quiet round with no upstream movement and no new measurement.
Standing remains `ctl3-rc2` (491.0/164.3); beat +2.0/+1.9 pooled, no keep.
Latest tag still `v0.30.0`. Ours still OPEN behind `pre-run-check`.

## 2026-09-22: protocol re-verified a forty-third time — routine unbroken (round 255)

vLLM still `v0.30.0`. Our four PRs still OPEN MERGEABLE BLOCKED, no rebase or
merge. No dep changes; no new arms.

Arithmetic only: the compliance audit re-read a forty-third time against
current files (same prompt, 160/160 full blocks, first-poll health, correct
