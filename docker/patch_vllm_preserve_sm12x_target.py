#!/usr/bin/env python3
"""Keep CUDA 13 vLLM CMake from collapsing 12.1a to family 12.0.

Copied from eugr spark-vllm-docker (docker/patch_vllm_preserve_sm12x_target.py).
Opt-in via VLLM_PRESERVE_SM12X_TARGET=1.
"""
