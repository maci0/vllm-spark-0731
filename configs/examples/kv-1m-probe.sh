...
exec bash harness/run-arm.sh kv1m-probe \
  "MAX_MODEL_LEN=1048576 GPU_MEMORY_UTILIZATION=0.90 MAX_NUM_SEQS=1 MAX_NUM_BATCHED_TOKENS=2048 DISABLE_DSPARK=1 ENFORCE_EAGER=1"
